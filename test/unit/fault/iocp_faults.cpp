...
struct iocp_faults
{
    ...
    */
    ...
    void testLocalSetupFails()
    {
        ...
        auto const ep = corosio::local_endpoint(dir.path());
        {
            ...
            // (src/corosio/src/local_stream_acceptor.cpp:97-109).
    ...
    */
    ...
    /* The error probe the wait reactor runs on a raised poll event.
       ...
       (win_tcp_acceptor_service.hpp:740-768). The peer is reset before
    ...
    */
    ...
    /* A context whose extension-pointer bootstrap never ran.
       ...
       load_extension_functions creates one socket to ask Winsock for
       ConnectEx and AcceptEx (win_tcp_acceptor_service.hpp:1239-1262);
       failing that socket leaves both pointers null for the whole
