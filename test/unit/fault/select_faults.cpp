...
struct select_faults
{
    ...
    */
    ...
    /* The per-descriptor SIGPIPE guard, where the platform has one.
       ...
       the only guard there is and set_fd_options treats a refusal as
       fatal (select_traits.hpp:203-215). Linux has no such option and
       compiles both arms away.
    */
