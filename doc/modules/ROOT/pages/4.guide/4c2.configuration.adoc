...
[source,cpp]
----
include::example$snippets/4c2_configuration.cpp[tag=options_basic_include]

include::example$snippets/4c2_configuration.cpp[tag=options_basic,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4c2_configuration.cpp[tag=options_native_include]

include::example$snippets/4c2_configuration.cpp[tag=options_native,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4c2_configuration.cpp[tag=locking_unsafe,indent=0]
----
